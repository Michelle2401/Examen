...
namespace Datos
{
    public class UsuarioDatos
    {
        ...
        public async Task<bool> InsertarAsync(Usuario usuario)
        {
            ...
            try
            {
                string sql = "INSERT INTO usuario VALUES (@Codigo, @Nombre, @Clave, @Correo, @Rol,";
        ...
        public async Task<bool> ActualizarAsync(Usuario usuario)
        {
            ...
            try
            {
                string sql = "UPDATE usuario SET Nombre=@Nombre, Clave=@Clave, Correo=@Correo, Rol=@Rol, WHERE Codigo=@Codigo";
